...
export class SelectedTagsAndStatus {
     ...
     */
    static getPlayerActivatedTagsAndStatusItems(filterFn = (_x) => true) {
        ...
        try {
            switch (subtype) {
                ...
                case "story":
                    ...
                    break;
                case null: throw new Error(`Resolution Error subtype ${subtype}, tag name: ${tag?.name}, owner: ${tagowner.name}`);
                case "loadout":
                    return 1;
                case "weakness":
                    return -1;
    ...
    static checkValidityForSelect(item, direction) {
