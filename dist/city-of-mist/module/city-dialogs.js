...
export class CityDialogs {
    ...
    */
    ...
    static async mergeWithStatusDialog(targetStatus, name, options) {
        const { tier } = options;
    ...
    static async statusDropDialog(actor, name, options) {
    ...
    */
    static _listGenFunction(_actor, theme, type, subtype) {
    ...
    static async getTagCreationData(presets = {}) {
        const data = {
            name: {
                initial: "Unnamed Tag",
    ...
    static async getStatusData(presets = {}) {
        const data = {
            name: {
