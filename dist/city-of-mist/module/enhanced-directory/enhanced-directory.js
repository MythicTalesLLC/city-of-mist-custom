...
class EnhancedItemDirectory {
    static init() {
        ...
        //@ts-ignore
        ItemDirectory._sortAlphabetical = function (a, b) {
...
class EnhancedActorDirectory {
    static init() {
        ...
        ActorDirectory.prototype.render = async function (...args) {
            ...
            const promises = game.actors.contents.map(async (actor) => {
        ...
        //@ts-ignore
        ActorDirectory.prototype._matchSearchEntries = function (query, entryIds, folderIds, autoExpandIds, options = {}) {
            //@ts-ignore
        ...
        //@ts-ignore
        ActorDirectory.prototype.onMatchFolder = function (folder, folderIds, autoExpandIds, { autoExpand = true } = {}) {
            //@ts-ignore
