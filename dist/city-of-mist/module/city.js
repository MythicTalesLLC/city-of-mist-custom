...
Hooks.on("encryptionPreEnable", (taragnorSec) => {
    ...
    taragnorSec.setEncryptable(CityActor, [CityCharacterSheet, CityThreatSheet, CityCrewSheet], ["system.gmnotes", "system.mythos"]);
    // eslint-disable-next-line @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access
    taragnorSec.setEncryptable(CityItem, [CityItemSheetLarge], ["system.description"]);
